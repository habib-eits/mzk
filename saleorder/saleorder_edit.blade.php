                        ...
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="PartyID" id="PartyID" class="form-select select2 mt-5" name="PartyID" required="">
                                            ...
                                            <?php foreach ($party as $key => $value) : ?>
                                                <option value="{{$value->PartyID}}" {{($value->PartyID== $saleorder_master[0]->PartyID) ? 'selected=selected':'' }}>{{$value->PartyName}}</option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-1 row " id="WalkinCustomer">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="WalkinCustomerName" value="{{$saleorder_master[0]->WalkinCustomerName}}" placeholder="Walkin cusomter" id="1WalkinCustomerName">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="UserID" id="UserID" class="form-select">
                                            ...
                                            <?php foreach ($user as $key => $value) : ?>
                                                <option value="{{$value->UserID}}" {{($value->UserID== $saleorder_master[0]->UserID) ? 'selected=selected':'' }}>{{$value->FullName}}</option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="first-name" class="form-control" name="Subject" value="{{$saleorder_master[0]->Subject}}" placeholder="Let your customer know what this invoice is for">
...
<div class="mb-1 row">
 ...
 <option value="TaxInclusive" {{('TaxInclusive'== $saleorder_master[0]->TaxType) ? 'selected=selected':'' }} >Tax Inclusive</option>
 <option value="TaxExclusive" {{('TaxExclusive'== $saleorder_master[0]->TaxType) ? 'selected=selected':'' }} >Tax Exclusive</option>
 </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9 pt-2">
                                            <input type="hidden" class="form-control" name="SaleOrderNo" value="{{$saleorder_master[0]->SaleOrderNo}}">{{$saleorder_master[0]->SaleOrderNo}}
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker21">
                                                <input type="text" name="SaleOrderDate" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="{{$saleorder_master[0]->SaleOrderDate}}">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker22">
                                                <input type="text" name="DueDate" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker22" data-provide="datepicker" data-date-autoclose="true" value="{{$saleorder_master[0]->ExpiryDate}}">
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="first-name" class="form-control" name="ReferenceNo" value="{{$saleorder_master[0]->ReferenceNo}}">
  ...
  <td valign="top">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                ...
                                <textarea class="form-control" rows='5' name="DescriptionNotes" id="note" placeholder="Description notes if any.">{{$saleorder_master[0]->DescriptionNotes}}</textarea>
                                ...
                                <div class="mt-2"><button type="submit" class="btn btn-success w-md float-right">Save</button>
                                    <a href="{{URL('/SaleOrder')}}" class="btn btn-secondary w-md float-right">Cancel</a>
                             ...
                             <div class="col-lg-4 col-12 ">
                                ...
                                <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="grandtotaltax" name="grandtotaltax" placeholder="Subtotal" value="{{$saleorder_master[0]->Tax}}" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="subTotal" name="SubTotal" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$saleorder_master[0]->SubTotal}}">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="discountper" name="DiscountPer" placeholder="Tax" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$saleorder_master[0]->DiscountPer}}">

                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>

                                            <input type="text" name="DiscountAmount" class="form-control" id="discountAmount" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$saleorder_master[0]->Discount}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Total" id="Total" class="form-control" step="0.01" id="totalafterdisc"   placeholder="Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$saleorder_master[0]->Total}}">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1 d-none">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="taxpercentage" name="Taxpercentage" placeholder="tax %" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$saleorder_master[0]->TaxPer}}">

                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>

                                            <input type="text" name="TaxpercentageAmount" class="form-control" id="taxpercentageAmount" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$saleorder_master[0]->Tax}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1 d-none">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Shipping" class="form-control" step="0.01" id="shipping" placeholder="Grand Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$saleorder_master[0]->Shipping}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Grandtotal" class="form-control" step="0.01" id="Grandtotal" placeholder="Grand Total"   onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$saleorder_master[0]->GrandTotal}}">
                                        </div>
                                    </div>
