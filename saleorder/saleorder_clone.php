    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{URL('/SaleOrderUpdate')}}" method="post">
                ...
                <input type="hidden" name="SaleOrderMasterID" value="{{$challan_master[0]->SaleOrderMasterID}}">
                            ...
                            <div class="col-md-6">
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="first-name" class="form-control" name="SaleOrderNo" value="{{$challan_master[0]->SaleOrderNo}}" disabled="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker21">
                                                <input type="text" name="SaleOrderDate" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="{{$challan_master[0]->SaleOrderDate}}">
