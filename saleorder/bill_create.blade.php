...
@section('content')
                        ...
                        <div class="card-body">
                                            ...
                                            <tr class="p-3">
                                                ...
                                                <td>
                                                    <input type="number" name="TaxAmount[]" id="TaxAmount_1"
                                                        class=" form-control TaxTotal " autocomplete="off"
                                                        onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                        onpaste="return false;" step="0.01">
                                                </td>
                                                <td>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-4 col-12 ">
                                    <input type="text" class="form-control" id="TotalTaxAmount" name="TaxTotal"
                                        placeholder="TaxTotal" onkeypress="return IsNumeric(event);"
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="DiscountAmount" class="form-control"
                                                    id="taxAmount" onkeypress="return IsNumeric(event);"
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td><input type="text" name="TaxPer[]" id="TaxPer_' + i +
                '" class="form-control changesNo " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
            html += '<td><input type="text" name="TaxAmount[]" id="TaxAmount_' + i +
                '" class="form-control  TaxTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
        ...
        $(document).on('  keyup blur select', '.changesNoo', function() {
            ...
            $('#TaxAmount_' + id[1]).val((parseFloat(json["SellingPrice"]) * (parseFloat(json["Percentage"]) / 100))
                .toFixed(2));
            ...
            $('#ItemTotal_' + id[1]).val((parseFloat(json["SellingPrice"]) * parseFloat($('#Qty_' + id[1]).val()) +
                    parseFloat($('#TaxAmount_' + id[1]).val()) - (parseFloat($('#discount_' + id[1]).val())))
                .toFixed(2));
