      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-print-block d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">SaleOrder</h4>
              ...
              <tbody>
                <tr >
                  ...
                  <td style="vertical-align: top; text-align:right;width:50%;">
                    ...
                    <span class="pcs-entity-title style1">{{$company[0]->SaleOrderInvoiceTitle}} </span><span class="style1"><br>
                      <b>SaleOrder # {{$saleorder[0]->SaleOrderNo}}</b></span>
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                ...
                <td style="width:60%;vertical-align:bottom;word-wrap: break-word;">
                    <div style="clear:both;width:50%;margin-top: 20px;">
                      <label style="font-size: 16pt;" class="pcs-label" id="tmp_shipping_address_label">SaleOrder To</label>
                      <br>
                      <span id="tmp_shipping_address" ><strong><span class="text-danger" id="zb-pdf-customer-detail"><a href="#">{{($saleorder[0]->PartyID==1) ? $saleorder[0]->WalkinCustomerName : $saleorder[0]->PartyName}}</a></span></strong><br>
                      <br>
TRN # {{$saleorder[0]->TRN}},<br>
                        {{$saleorder[0]->Address}}<br>
                        {{$saleorder[0]->Phone}}<br>
                        {{$saleorder[0]->Email}}
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align:right;">
                            <span id="tmp_entity_date">{{$saleorder[0]->Date}}</span>                          </td>
                        </tr>
                    
                        <tr>
                          <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">Expiry Date: </td>
                          <td style="text-align:right;"><span id="tmp_ref_number">{{$saleorder[0]->ExpiryDate}}</span> </td>
                        </tr>
                            <tr>
                          <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                            <span class="pcs-label">Ref# :</span>                          </td>
                          <td style="text-align:right;">
                            <span id="tmp_ref_number">{{$saleorder[0]->ReferenceNo}}</span>                          </td>
                        </tr>
                      </tbody>
                    </table>
                  </td>
              ...
              <div style="width: 45%;padding: 3px 10px 3px 3px;font-size: 9pt;float: left;">
                <div style="white-space: pre-wrap;">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%"><strong>Description :</strong> {{$saleorder[0]->DescriptionNotes}}</td>
                    </tr>
                    <tr>
                      <td width="50%"><strong>Customer Notes : </strong>{{$saleorder[0]->CustomerNotes}}</td>
                    </tr>
                  </table>
                </div>
              </div>
  ...
  <tr   class="pcs-balance">
            ...
            <td height="25" align="right" valign="middle" id="tmp_total" style="width:120px;;padding: 10px 10px 10px 5px;"><div align="right"><b>{{$saleorder[0]->DiscountPer}}</b></div></td> 
              </tr> 
  <tr   class="pcs-balance">
            <td height="25" align="right" valign="middle"  ><b>Discount</b></td>  
  ...
  <tr   class="pcs-balance">
            ...
            <td height="25" align="right" valign="middle" id="tmp_total" style="width:120px;;padding: 10px 10px 10px 5px;"><div align="right"><b>{{$saleorder[0]->GrandTotal}}</b></div></td> 
  </tr> 
        </tbody>
      </table>
              </div>
              ...
              <table cellspacing="0" border="0" width="100%">
                <tbody>
                  <tr class="bg-light" style="height: 30px;">
                    ...
                    <td width="90%" class="total-in-words-value text-align-left "><i><b> {{convert_number_to_words($saleorder[0]->Total)}} only </b></i></td>
                  </tr>
                </tbody>
              </table>
