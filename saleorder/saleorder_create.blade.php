                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="SaleOrderNo" autocomplete="off" class="form-control" value="SO-{{$saleorder_master[0]->SaleOrderNo}}">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="JobNo" autocomplete="off" class="form-control" value="JOB-{{$job_number->JobNo}}" required>
