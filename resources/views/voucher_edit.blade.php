    ...
    <div class="row">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                   <select class="form-control changesNooo" name="InvoiceType1" id="InvoiceType1">
           ...
           <?php $no = $key+1; ?>
            ...
            <tr  class="bg-light border-1 border-light" >
              ...
              <td >
                 ...
                 <select name="ChOfAcc[]" id="ItemID0_{{$no}}" class="  form-select form-control-sm select2  " style="width: 100% !important;">
                  @foreach ($chartofaccount as $key => $value) 
                    <option value="{{$value->ChartOfAccountID}}"  {{($value->ChartOfAccountID== $value1->ChOfAcc) ? 'selected=selected':'' }}   >{{$value->ChartOfAccountID}}-{{$value->ChartOfAccountName}}</option>
                  @endforeach
                 </select>
               </td> 
               <td  > <select name="SupplierID[]" id="SupplierID_{{$no}}" class=" select2 form-select " onchange="ajax_balance(this.value);" style="width: 100% !important;">
                ...
                <td  > <select name="PartyID[]" id="PartyID_{{$no}}" class=" select2 form-select " onchange="ajax_balance(this.value);" style="width: 100% !important;">
                <option value="">Select Supplier</option>
                  ...
                  @endforeach
                      ...
                      <td style="width: 300px !important;" > 
                         <select name="EmployeeID[]" id="EmployeeID_{{$no}}" class="  select2 form-select " onchange="ajax_balance(this.value);" style="width: 100% !important;">
                          <option value="">Select Employee</option>
                          @foreach ($employee as $key => $value)
                          <option value="{{$value->EmployeeID}}" {{($value->EmployeeID== $value1->EmployeeID) ? 'selected=selected':'' }}>{{$value->full_name}}</option>
                          @endforeach
                        </select>
                      </td>
