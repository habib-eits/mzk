                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Hi! <strong>{{ $mailData['name'] }}</strong> , We're excited to have you get started with your CRM account as a <strong>{{ $mailData['role'] }}</strong>. Just press the button below to
