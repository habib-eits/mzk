...
<body oncontextmenu='return false' class='snippet-body'>
    <div
        ...
        Your Account Credentials has been Changed By the Admin! Get ready to dive into your new account. </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Hi! <strong>{{ $mailData['name'] }}</strong> , Your Account Credentials has been Changed By the Admin! We're excited to have you get started with your CRM account as a <strong>{{ $mailData['role'] }}</strong>. Just press the button below to
                                Login, use the following credentials</p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;"> <strong>Email: </strong>{{ $mailData['email'] }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 3px;" bgcolor="#24a0ed"><a
                                                        href="{{ url('login') }}"
                                                        target="_blank"
                                                        style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 10px 25px; border-radius: 2px; border: 1px solid #24a0ed; display: inline-block;">Login</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    {{-- <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;"><a href="#" target="_blank"
                                    style="color: #24a0ed;">https://retailer-erp.cplusoft.top/login</a></p>
                        </td>
                    </tr> --}}
                    {{-- <tr>
                        <td bgcolor="#ffffff" align="left"
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Cheers,<br>CRM Team</p>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ADD8E6" align="center"
                            ...
                            <p style="margin: 0;"><a href="#" target="_blank"
                                    style="color: #24a0ed;">We&rsquo;re here to help you out</a></p>
                        </td>
                    </tr>
                </table>
            </td>
