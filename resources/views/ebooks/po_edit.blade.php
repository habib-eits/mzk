        ...
        <div class="page-content">
            <div class="container-fluid">
                <form action="{{ URL('/PurchaseOrderUpdate') }}" method="post">
                    <input type="hidden" name="PurchaseOrderMasterID"
                        value="{{ $purchaseorder_master[0]->PurchaseOrderMasterID }}">
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                                            ...
                                            <select name="SupplierID" id="SupplierID" class="form-select select2 mt-5"
                                                ...
                                                @foreach ($supplier as $key => $value)
                                                    <option value="{{ $value->SupplierID }}"
                                                        {{ $value->SupplierID == $purchaseorder_master[0]->SupplierID ? 'selected=selected' : '' }}>
                                            ...
                                            <select name="UserID" id="UserID" class="form-select">
                                                ...
                                                @foreach ($user as $key => $value)
                                                    <option value="{{ $value->UserID }}"
                                                        {{ $value->UserID == $purchaseorder_master[0]->UserID ? 'selected=selected' : '' }}>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="first-name" class="form-control" name="Subject"
                                                ...
                                                value="{{ $purchaseorder_master[0]->Subject }}">
                                        </div>
                                    </div>
                                    <div class="mb-1 row">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="UserI D" id="seletedVal" class="form-select"
                                                ...
                                                @foreach ($tax as $key => $valueX1)
                                                    @if ($purchaseorder_master[0]->Tax != 0)
                                                        <option value="{{ $valueX1->TaxPer }}"
                                                            {{ $valueX1->TaxPer == 5 ? 'selected' : '' }}>
                                                            {{ $valueX1->Description }}
                                                        </option>
                                                    @else
                                                        <option value="{{ $valueX1->TaxPer }}"
                                                            {{ $valueX1->TaxPer == 0 ? 'selected' : '' }}>
                                                            {{ $valueX1->Description }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="JobNo" class="form-control"
                                                    value="{{ $purchaseorder_master[0]->JobNo }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9 pt-2 fw-bold">
                                                <input type="text" id="first-name" class="form-control"
                                                    name="PurchaseOrderNo" value="{{ $purchaseorder_master[0]->PON }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group" id="datepicker21">
                                                    <input type="text" name="Date" autocomplete="off"
                                                        ...
                                                        value="{{ $purchaseorder_master[0]->Date }}">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group" id="datepicker22">
                                                    <input type="text" name="DueDate" autocomplete="off"
                                                        ...
                                                        data-provide="datepicker" data-date-autoclose="true"
                                                        value="{{ $purchaseorder_master[0]->DeliveryDate }}">
                                                    <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="ReferenceNo" autocomplete="off"
                                                    class="form-control"
                                                    value="{{ $purchaseorder_master[0]->ReferenceNo }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if ($purchaseorder_master[0]->JobNo == null)
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-8 col-12  ">
                                    ...
                                    <textarea class="form-control" rows='5' name="DescriptionNotes" id="note"
                                        placeholder="Description notes if any.">{{ $purchaseorder_master[0]->DeliveryNotes }}</textarea>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="subTotal"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" readonly value="{{ $purchaseorder_master[0]->SubTotal }}">
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="Total" class="form-control" step="0.01"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" value="{{ $purchaseorder_master[0]->GrandTotal - $purchaseorder_master[0]->Tax }}">
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="grandtotaltax"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" value="{{ $purchaseorder_master[0]->Tax }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="Grandtotal" class="form-control"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;"
                                                    value="{{ $purchaseorder_master[0]->GrandTotal }}">
                                            </div>
                                        </div>
                                        <div class="form-group mt-1 d-none ">
        ...
        function GetSelectedTextValue(seletedVal) {
            ...
            if (gTotalVal > 0) {
                ...
                if (confirm("Are you sure you want to update tax of complete invoice!")) {
                    ...
                    $('#totalafterdisc').val(parseFloat(grandsum - discountamount).toFixed(2));
