...
$chartofaccount = DB::table('chartofaccount')->select('ChartOfAccountName')->where('ChartOfAccountID',$payment_master[0]->ChartOfAccountID)->first();
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody class="font">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td>Account Namne </td>
                                    <th>{{$chartofaccount->ChartOfAccountName   }}</th>
                                </tr>
