                ...
                <div class="card">
                    <div class="card-body">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div align="center" class="style1">VENDOR BALANCE </div>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            @foreach ($supplier as $value)
                                ...
                                $sql = DB::table('journal')->select(DB::raw('sum(if(ISNULL(Dr),0,Dr)-if(ISNULL(Cr),0,Cr)) as Balance'))->where('SupplierID', $value->SupplierID)->where('ChartOfAccountID', 210100)->where('Date', '<', request()->StartDate)// ->whereBetween('date',array($request->StartDate,$request->EndDate))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div align="right">
                                            {{ $sql[0]->Balance == null ? 0 : number_format($sql[0]->Balance, 2) }}</div>
                                    </td>
                                    ...
                                    <td>
                                        <div align="right">
                                            {{ count($opening_bal) > 0 ? number_format($opening_bal[0]->Balance, 2) : 0 }}
                                        </div>
                                    </td><?php $start_date1 = date ("Y-m-d", strtotime("+1 month", strtotime($start_date1)));     } ?>
                                    <td>
                                        <div align="right">{{ number_format($grand + $opening, 2) }}</div>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
