                        ...
                        <form action="{{ URL('/CompanyUpdate') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                <div>
                                    ...
                                    <div class="mb-2 row">
                                        <label for="example-url-input" class="col-md-3 col-form-label fw-bold">Bank
                                            Details</label>
                                        <div class="col-md-6">

                                            <textarea name="DigitalSignature" id="DigitalSignature" cols="30" rows="10" class="form-control">
                          {{ $DigitalSignature }}
                        </textarea>
