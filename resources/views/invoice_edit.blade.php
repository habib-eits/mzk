...
<select name="PartyID" id="PartyID" class="form-select select2 mt-5" name="PartyID" required="">
 <?php foreach ($supplier as $key => $value): ?>
     <option value="{{$value->SupplierID}}" {{($value->SupplierID== $invoice_mst[0]->PartyID) ? 'selected=selected':'' }}>{{$value->SupplierName}}</option>
   <?php endforeach ?>
</select>
</div>
  </div>
    ...
    <div class="row">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text"  name="Date" class="form-control invoice-edit-input date-picker flatpickr-input active" readonly="readonly" value="{{$invoice_mst[0]->Date}}">
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text"  name="DueDate" class="form-control invoice-edit-input date-picker flatpickr-input active" readonly="readonly" value="{{$invoice_mst[0]->DueDate}}">
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <option value="Bank Transfer" {{($invoice_mst[0]->PaymentMode=='Bank Transfer') ? 'selected=selected':'' }}>Bank Transfer</option>
        ...
        <div class='row'>
          ...
          <tbody>
            ...
            <tr class="p-3">
              ...
              <td> <select name="SupplierID[]" id="SupplierID_{{$no}}" class=" form-select changesNo" onchange="ajax_balance(this.value);">
              ...
              <td>
                <input type="number" name="Taxable[]"  id="Taxable_{{$no}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Taxable}}" >
              </td>
              <td>
                <input type="number" name="Service[]" id="Service_{{$no}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Service}}">
              </td>
              <td>
              ...
              <td>
                <input type="number" name="TaxAmount[]" id="quantity_{{$no}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Taxable}}">
              </td>
              <td>
