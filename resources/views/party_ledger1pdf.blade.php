...
<body>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2"><div align="center">{{$party[0]->PartyName}} - {{$party[0]->PartyID}}</div></td>
  </tr>
  <tr>
    <td colspan="2"><div align="center">Contact : {{$party[0]->Phone}}</div></td>
  </tr>
  <tr>
    <td colspan="2"><div align="center">From {{session::get('StartDate')}} TO {{session::get('EndDate')}}
    </div></td>
  </tr>
  <tr>
    ...
    <td width="50%">&nbsp;</td>
        ...
        <table width="100%" border="1" align="center" cellpadding="3" style="border-collapse: collapse;">
          ...
          <th bgcolor="#CCCCCC"  ><div align="center">Type</div></th>
  ...
  <td><div align="center"></div></td>
          ...
          @foreach ($journal as $key =>$value)
           ...
           <td ><div align="center">{{$value->JournalType}}</div></td>
