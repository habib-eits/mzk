  ...
  <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-print-block d-sm-flex align-items-center justify-content-between">
                                 ...
                                 <a href="{{URL('/BookingCreate/1')}}" class="btn btn-danger btn-rounded waves-effect waves-light mb-2 me-2"><i class="bx bx-plus me-1"></i> Add New</a>
                                    ...
                                    <tbody>
                                        @foreach ($booking as $key => $item)
                                            <tr>
                                                ...
                                                <td>{{ datetimeformat($item->start) }}</td>
                                                <td>{{ datetimeformat($item->end) }}</td>
                                                 <td>
