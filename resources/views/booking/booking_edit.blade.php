...
" ></option>
      ...
      <div class="col-md-2">
        ...
        <input type="text" class="form-control" name="net_profit"  id="net_profit"  readonly="" value="{{$booking[0]->net_profit}}">
        </div>
        </div>
        ...
        <textarea id="verticalnav-address-input" class="form-control" rows="3" name="remarks">{{$booking[0]->title}}</textarea>
        </div>
        </div>
...
$(document).ready(function(){
    ...
    $('#vendor_cost').keyup(function(){
       ...
       $('#cnc_cost').keyup(function(){
        ...
        // Get the selected value
        vendor_cost = parseFloat( $('#vendor_cost').val() );
        cnc_cost = parseFloat($('#cnc_cost').val());
        ...
        net_profit = parseFloat(profit)- parseFloat(output_vat);
         ...
         $('#net_profit').val(net_profit.toFixed(2));
             ...
             if(cnc_cost <vendor_cost)
             {
              $('#cnc_cost').css('background-color', 'red');
             }
               else
             {
              $('#cnc_cost').css('background-color', '');
             }
