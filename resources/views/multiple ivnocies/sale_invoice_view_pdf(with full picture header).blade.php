...
<body class="invoice">
    ...
    <table class="head container">
        <tr>
            <td class="header">
                <div align="center"><img src="{{ URL('/documents/' . $company[0]->Logo) }}" style="width:100%;" /> </div>
                <div class="shop-name">
                    <div align="right"><br />
                    </div>
                </div>
        ...
        <tr>
            <td class="header">
                <div align="center">
                    ...
                    <h2 style="margin-top: 15px;"><u>CUSTOMER COPY</u></h2>
                </div>
            </td>
        </tr>
    </table>
    <table class="order-data-addresses">
        <tr>
            <td valign="bottom" class="address billing-address">
                <strong>{{ $invoice_master[0]->PartyName }} -
                    {{ $invoice_master[0]->WalkinCustomerName }}</strong><br />
    ...
    <table class="order-details">
        ...
        <tbody>
            ...
            @endforeach
            <?php  for($i = 8; $i>=count($invoice_detail);$i--) { ?>
            ...
            <tr class="no-borders">
                <td colspan="3" class="no-borders">
                    <div class="customer-notes"><strong>Customer Notes:
                        </strong>{{ $invoice_master[0]->CustomerNotes }}. </div>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p><strong>Customer Signature's</strong> </p>
                    <p>&nbsp;</p>
                    <p><br>
                        <br>
                        <strong>..............................................................</strong>
                        ...
                        <tfoot>
                            <tr class="cart_subtotal">
                                ...
                                <td class="price"><span class="totals-price"><span class="amount">
                                            {{ number_format($invoice_master[0]->SubTotal - $invoice_master[0]->Tax, 2) }}</span></span>
                                </td>
                            </tr>
                            ...
                            <tr class="order_total">
                                ...
                                <td class="price"><span class="totals-price"><span
                                            class="amount">{{ number_format($invoice_master[0]->SubTotal, 2) }}</span></span>
                                </td>
                            </tr>
                            <tr class="order_total">
                                <td class="no-borders"></td>
    ...
    <table class="head container">
        <tr>
            <td class="header">
                <div align="center"><img src="{{ URL('/documents/' . $company[0]->Logo) }}" style="width:100%;" />
                </div>
                <div class="shop-name">
                    <div align="right"><br />
                    </div>
        ...
        <tr>
            <td class="header">
                <div align="center">
                    <h2><u>{{ strtoupper($invoice_master[0]->InvoiceType) }}</u></h2>
                    <h2 style="margin-top: 15px;"><u>OFFICE COPY</u></h2>
                </div>
            </td>
        </tr>
    </table>
