                                        ...
                                        @foreach ($chartofaccountr as $value)
                                            ...
                                            @foreach ($chartofaccount_l2 as $value1)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a target="_blank"
                                                            href="{{ URL('/BalanceSheetDetail/' . $value1->ChartOfAccountID . '/' . request()->StartDate . '/' . request()->EndDate) }}">{{ $activity[0]->Balance == null ? '0' : number_format($activity[0]->Balance, 2) }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            <tr>
                                        ...
                                        @foreach ($chartofaccounte as $value)
                                            ...
                                            @foreach ($chartofaccount_l2 as $value1)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a target="_blank"
                                                            href="{{ URL('/BalanceSheetDetail/' . $value1->ChartOfAccountID . '/' . request()->StartDate . '/' . request()->EndDate) }}">{{ $activitye[0]->Balance == null ? '0' : number_format($activitye[0]->Balance, 2) }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            ...
                                            <tr>
                                                <td></td>
                                                <td style="text-indent: 20px;"><strong>Total
                                                        {{ $value->ChartOfAccountName }}</strong></td>
                                                <td>{{ $SubTotal }}</td>
                                            </tr>
