                  ...
                  <tbody>
                    <tr class="p-3">
                      ...
                      <td>
                        ...
                        <input name="ItemID0[]" id="ItemID_1" placeholder="Please type product code and select..." class="item form-control tags changesNoo " data-type="productCode" />
...
<script>
  ...
  $(".addmore").on('click', function() {
    ...
    html += '<td> <input name="ItemID0[]" id="ItemID_' + i + '" placeholder="Please type product code and select..." class="item form-control tags changesNoo " /><input type="text" name="ItemID[]" id="ItemID0_' + i + '"></td>';
  ...
  $(document).on(' keyup blur select', '.changesNoo', function() {
    ...
    $('#ItemTotal_' + id[1]).val((parseFloat(json["SellingPrice"]) * parseFloat($('#Qty_' + id[1]).val()) - (parseFloat($('#discount_' + id[1]).val()))).toFixed(2));
