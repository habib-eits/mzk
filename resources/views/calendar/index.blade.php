                ...
                <div class="col-md-6">
                  ...
                  <table class="table table-sm   table-hover">
                    ...
                    <tbody>
                       ...
                       <tr>
                        <td style="font-weight: bold;">Ouytput VAT</td>
                       ...
                       <tr>
                        <td style="font-weight: bold;">Net Proft</td>
                        <td style="text-align: left;" id="net_profit"></td>
                      </tr>
...
"></option>
        ...
        <div class="col-6 text-end">
            ...
            <button type="submit" class="btn btn-success w-md" id="btn-save-event">Save</button>
        </div>
    </div>
    ...
    <script>
       ...
       nextDayThreshold: '12:00:00',
        ...
        const data = {
            ...
            end: event.end.format('Y-MM-DD h:mm:ss'),  // New start time
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                eventClick: function(event){
                    ...
                    $('#net_profit').text(event.net_profit);
