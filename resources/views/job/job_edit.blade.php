...
@endif
 ...
 <input type="hidden" name="_token" id="csrf" value="{{ csrf_token() }}">
         ...
         <div class="row">
                ...
                <input type="date" class="form-control" name="JobDate" id="JobDate" value="{{$job->JobDate}}" required="">
                </div>
                </div>
                ...
                <input type="date" class="form-control" name="JobDueDate" id="JobDueDate" value="{{$job->JobDueDate}}" required="">
                </div>
                </div>
                 ...
                 <div class="mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="ShiftType" id="ShiftType" class="form-select">
                                <option value="Day" {{($job->ShiftType=='Day') ? 'selected=selected':'' }}>Day</option>
                                <option value="Night" {{($job->ShiftType=='Night') ? 'selected=selected':'' }}>Night</option>
                                <option value="'Day & Night" {{($job->ShiftType=='Day & Night') ? 'selected=selected':'' }}>Day & Night</option>
                   ...
                   <div class="col-md-4 d-none">
                    <div class="mb-3">
                    <label for="basicpill-firstname-input">Qtn Reference <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="QtnReference"  id="QtnReference" value="{{$job->QtnReference}}"  >
                    </div>
                    </div>
   ...
   <div class="col-md-8">
                ...
                <div class="col-md-2">
                    <div class="mb-3">
                    <label for="basicpill-firstname-input">Job Location <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="JobLocation" value="{{$job->JobLocation}}" required="" id="JobNo">
                    </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="Status" id="Status" class="form-select">
                            <option value="1" {{($job->Status=='1') ? 'selected=selected':'' }} >Active</option>
                            <option value="0" {{($job->Status=='0') ? 'selected=selected':'' }}>Close</option>
                        </select>
                    </div>
                  </div>
