...
<head>
    ...
    <style>
        ...
        .header-table, .client-invoice-table, .items-table, .summary-table, .signature-table {
            width: 100%;
...
<div class="container">
    ...
    <table class="header-table">
        <tr>
            <td class="w-50">
                <img src="{{ public_path('custom/mzk-tech-logo.png') }}" alt="Logo" style="width: 150px; height: auto;">
                <p class="company-info">
                    <strong>MZK TECHNICAL SERVICES LLC</strong><br>
                    TRN: 104156841900003
                </p>
            </td>
            <td class="w-50 text-right">
                <table class="client-invoice-table">
                    <tr>
                        ...
                        <td>{{ $invoice_no ?? '10001' }}</td>
                    </tr>
                    <tr>
                        <th>Tax Invoice Date</th>
                        <td>{{ $invoice_date ?? '11-08-2025' }}</td>
                    </tr>
                    <tr>
                        <th>Payment Terms</th>
                        <td>30 Days</td>
    ...
    <div class="project-title">PROJECT: AL FALAH # ABU DHABI - UAE</div>
    ...
    <table class="client-invoice-table">
        ...
        <tr>
            <td colspan="2"><strong>National Projects and Construction LLC</strong></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="w-50" style="vertical-align: top;">
                <table class="summary-table">
                    <tr><td>Total Invoice Amount:</td><td class="text-right">205,915.70</td></tr>
                    <tr><td>Less Previous Invoice (excl 10% Ret):</td><td class="text-right">120,611.61</td></tr>
                    <tr><td>10% Retention up to Apr 2024:</td><td class="text-right">13,401.90</td></tr>
                    <tr><td><strong>Sub Total:</strong></td><td class="text-right">71,902.97</td></tr>
                    <tr><td>Current 10% Retention:</td><td class="text-right">7,190.30</td></tr>
                    <tr><td><strong>Net Invoice Amount:</strong></td><td class="text-right">64,712.67</td></tr>
                    <tr><td>VAT 5%:</td><td class="text-right">3,595.15</td></tr>
                    <tr><td>VAT Retention 5%:</td><td class="text-right">359.51</td></tr>
                    <tr><td><strong>Applicable VAT:</strong></td><td class="text-right">3,235.63</td></tr>
                    <tr><td><strong>NET AMOUNT AED:</strong></td><td class="text-right">67,948.31</td></tr>
                    <tr>
                        <td colspan="2">
