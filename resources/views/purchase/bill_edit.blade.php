                                        ...
                                        <div class="col-sm-9">
                                            <select name="SupplierID" id="SupplierID" class="form-select select2 mt-5"
                                                ...
                                                <option value="{{ $value->SupplierID }}"
                                                    {{ $value->SupplierID == $invoice_master[0]->SupplierID ? 'selected=selected' : '' }}>
                                    ...
                                    <table>
                                        <thead>
                                            <tr class="bg-light borde-1 border-light " style="height: 40px;">
                                                ...
                                                <th width="5%" class="d-none">DESCRIPTION </th>
                                                <th width="1%">UNIT</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($invoice_detail as $key => $value1)
                                                ...
                                                <tr class="p-3">
                                                    ...
                                                    <td class="d-none"><input type="text" name="Description[]"
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td><select name="ItemID0[]" id="ItemID0_' + i +
                ...
                ');" style="width: 300px !important;"> <option value="">select</option>}@foreach ($items as $key => $value) <option value="{{ $value->ItemID }}|{{ $value->Percentage }}">{{ $value->ItemCode }}-{{ $value->ItemName }}-{{ $value->Percentage }}</option>@endforeach</select><input type="hidden" name="ItemID[]" id="ItemID_' +
                i + '"></td>';



            html += '  <td class="d-none"><input type="text" name="Description[]" id="Description_' + i +
            ...
            html += '<td class="d-none"><input type="number" name="UnitQty[]" id="UnitQty_' + i +
