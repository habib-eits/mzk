                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; text-align:right;width:50%;">
                                            ...
                                            <b>DEBIT NOTE # {{ $invoice_master[0]->InvoiceNo }}</b></span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right;">
                                                            <span
                                                                id="tmp_entity_date">{{ $invoice_master[0]->Date }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                        ...
                                                        <td style="text-align:right;">
                                                            <span
                                                                id="tmp_ref_number">{{ $invoice_master[0]->DueDate }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                        ...
                                                        <td style="text-align:right;">
                                                            <span
                                                                id="tmp_ref_number">{{ $invoice_master[0]->ReferenceNo }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                        ...
                                                        <td style="text-align:right;">
                                                            <span id="tmp_ref_number">{{ $invoice_master[0]->PaymentMode }}
                                                                - {{ $invoice_master[0]->PaymentDetails }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                ...
                                                <div>
                                                    <div>
                                                        ...
                                                        <span style="white-space: pre-wrap;word-wrap: break-word;"
                                                            class="pcs-item-desc"
                                                            id="tmp_item_description">{{ $value->ItemName . ' - ' . $value->Description }}
                                                        </span>
                                                    </div>
                                                </div>
                                            </td>
                                ...
                                <div style="width: 45%;padding: 3px 10px 3px 3px;font-size: 9pt;float: left;">
                                    <div style="white-space: pre-wrap;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <div align="left">{{ $invoice_master[0]->CustomerNotes }} </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div align="left">{{ $invoice_master[0]->DescriptionNotes }} </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <table class="pcs-totals" cellspacing="0" border="0" width="100%">
                                        <tbody>
                                            ...
                                            <tr class="pcs-balance">
                                                ...
                                                <td height="25" align="right" valign="middle" id="tmp_total"
                                                    style="width:120px;;padding: 10px 10px 10px 5px;">
                                                    <div align="right"><b>{{ $invoice_master[0]->DiscountAmount }}</b>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endif
                                            ...
                                            <tr class="pcs-balance">
                                                ...
                                                <td height="25" align="right" valign="middle" id="tmp_total"
                                                    style="width:120px;;padding: 10px 10px 10px 5px;">
                                                    <div align="right"><b>{{ $invoice_master[0]->GrandTotal }}</b></div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
