 ...
 <div class="row">
      <div class="col-lg-12">
       ...
       <div class="table-responsive">
        <table class="table table-sm  m-0" id="student_table">
            <thead>
               <tr>
                 <th>Party Code</th>
                <th>Name</th>
        ...
        <a href="{{URL('/SupplierDetail/'.$value->SupplierID)}}" class="text-secondary"><i class="mdi mdi-eye-outline font-size-15"></i></a>
