 ...
 @if (count($errors) > 0)
  ...
  <div class="card">
    ...
    <tr>
      ...
      <td width="50%" align="right"> From {{request()->StartDate}} TO {{request()->EndDate}}</td>
    </tr>
  </table>
...
$TotalQtyOut = $TotalQtyOut + $value->QtyOut;
 ...
 ?>
    ...
    <tr>
      ...
      <td><div align="left">{{$value->ItemName}} <a href="{{URL('/lnventoryDetail/'.$value->ItemID.'/'.request()->StartDate.'/'.request()->EndDate)}}" target="_blank">[...]</a></div></td>
