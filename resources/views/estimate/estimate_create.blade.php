                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-1 row ">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <label class="col-form-label text-danger" for="password">Subject </label>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="PaymentTerm" value="Net 60 days"  
                                                    class="form-control" >
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="MaterialAvailability" value=""  
                                                    class="form-control" >
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-8 col-12  ">
                                    ...
                                    <textarea class="form-control editme" rows='5' name="CustomerNotes" id="note" placeholder=""><strong>Duration:</strong> 10-12 Working Days<br>

<strong>General:</strong> <strong>{{ $company->Name }}</strong> reserves the right to modify this quotation<br>
...
If you have any questions, please do not hesitate to contact {{ $company->Name }}<br>
 ...
 $(document).ready(function () {
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<textarea name="Description[]" rows="2" class="form-control mt-1 kashif tiny-editor" style="width: 100% !important;"></textarea>';
    ...
    $('#contactForm').on('submit', function(e) {
        ...
        // Ensure TinyMCE updates the textarea before submission
        tinymce.triggerSave();
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                }, 5000); // Auto-hide alert after 5 seconds
            },
            error: function(e) {
                btn.prop('disabled', false);
                btn.html('Submit');
