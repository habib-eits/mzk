                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-1 row">
                                       ...
                                       <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="first-name" class="form-control" name="EquipmentUser_PlantSite" >
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="EstimateNo" autocomplete="off"
                                                    class="form-control"
                                                    value="EST-{{ $estimate_master[0]->EstimateNo }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <table>
                                        <thead>
                                            <tr class=" borde-1 border-light " style="height: 40px;">
                                                ...
                                                <th width="10%">RATE</th>
                                                <th width="12%" class="d-none">DISCOUNT</th>
                                                <th width="6%">Value for Tax</th>
                                                <th width="6%">Tax</th>
                                                <th width="6%">Tax Val</th>
                                                <th >AMOUNT</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="p-3">
                                                <td bordercolor="1" class="p-1    text-center"><input class="case"
                                                        type="checkbox" /></td>
                                                <td valign="top">
                                                    <select name="ItemID0[]" id="ItemID0_1"
                                                        ...
                                                        @foreach ($items as $key => $value)
                                                            <option value="{{ $value->ItemID }}">{{ $value->ItemName }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <td valign="top">
                                                    ...
                                                    <td valign="top">
                                                    <select  class="form-select" name="LS[]" id="LS_1"><option value="YES">YES</option>        <option value="NO">NO</option>    </select>
                                                </td>
                                        ...
                                        <div class="form-group mt-1" >
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="grandtotaltax"
                                                    name="grandtotaltax" placeholder="Grand Total Tax"
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" readonly>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td><select name="ItemID0[]" id="ItemID0_' + i +
                ...
                i +
                '"></td>';
                html += '<td valign="top"><textarea name="Description[]" id="Description[]" rows="2" class="form-control" style="width: 400px !important;"></textarea></td>'

            html += '<td valign="top"> <select  class="form-select" name="LS[]" id="LS_' + i +'"><option value="YES">YES</option>        <option value="NO">NO</option>    </select></td>';
            ...
            html += '<td valign="top" class="d-none"><div class="input-group"><input type="text" name="Discount[]" id="Discount_' +
                i +
        ...
        $(document).on('change keyup', '.changesNoo', function() {
            id_arr = $(this).attr('id');
            id = id_arr.split("_");
            val = $('#ItemID0_' + id[1]).val().split("|");
            $('#ItemID_' + id[1]).val(val[0]);
        ...
        $(document).on('chnage keyup blur', '#discountAmount', function() {
