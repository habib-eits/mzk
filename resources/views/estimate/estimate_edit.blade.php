...
@section('content')
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <option value="">Select
                                                ...
                                                <option value=" {{ $value->UserID }}"
                                                    {{ $value->UserID == $estimate_master[0]->UserID ? 'selected=selected' : '' }}>
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" id="first-name" class="form-control editme" name="Subject"
                                                value="{{$estimate_master[0]->Subject}}"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <label class="col-form-label" for="password">Payment Terms </label>
    
                                                </div>
    
                                                <div class="col-sm-9">
    
                                                    <input type="text" name="PaymentTerm" value="{{$estimate_master[0]->PaymentTerm}}"  
                                                        class="form-control" >
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <label class="col-form-label" for="password">Material Availability  </label>
    
                                                </div>
    
                                                <div class="col-sm-9">
    
                                                    <input type="text" name="MaterialAvailability" value="{{$estimate_master[0]->MaterialAvailability}}"  
                                                        class="form-control" >
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($estimate_detail as $key => $value1)
                                                ...
                                                <tr class="p-3">
                                                    ...
                                                    <td valign="top"><select name="UnitName[]"
                                                            id="UnitName_{{ $no }}" class="form-select">
                                                            ...
                                                            <select name="Status[]" id="status_{{$no}}" class="form-select mt-1">

                                                                <option value="Pending" {{($value1->Status=='Pending') ? 'selected=selected':'' }}
                                                                >Pending</option>
                                                                <option value="Completed" {{($value1->Status=='Completed') ? 'selected=selected':'' }}>Completed</option>
                                                            </select>
                                                    ...
                                                    <td valign="top">
                                                        ...
                                                        <select class="form-select mt-1" name="LS[]"
                                                            id="LS_{{ $no }}">
                                                            ...
                                                            <option value="NO"
                                                                {{ $value1->LS == 'NO' ? 'selected=selected' : '' }}>LS / NO
                                                            </option>
 ...
 $(document).ready(function () {
    tinymce.init({
                                    selector : "textarea,.editme", // Select all textarea exluding the mceNoEditor class
                                      height: 200,
                                     menubar: false,
                                     plugins: [
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<select name="ItemID0[]" id="ItemID0_' + i +
            ...
            html += '<textarea name="Description[]" id="Description_' + i +
                '" rows="2" class="form-control mt-1 kashif tiny-editor" style="width: 100% !important;"></textarea>';
            ...
            html += '</select><select name="Status[]" id="status_'+i+'" class="form-select mt-1"> <option value="Pending"    >Pending</option><option value="Completed" >Completed</option> </select>';
            ...
            html += '<input type="number" name="UnitQty[]" id="UnitQty_' + i +
                '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="">';
            ...
            html += '<input type="text" name="Qty[]" id="Qty_' + i +
                '" class="form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="1">';
            ...
            html += '<input type="text" name="Price[]" id="Price_' + i +
                '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">';
            ...
            html += '<input type="text" name="Discount[]" id="Discount_' + i +
                '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="0">';

            html += '<span>';

            html += '<div class="col-sm-9 input-group">';

            html += '<select name="DiscountType[]" id="DiscountType_' + i +
                '" class="form-select changesNo bg-light">';
            ...
            html += '<input type="number" name="Gross[]" id="Gross_' + i +
                '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01">';
            ...
            html += '<select name="Tax[]" id="TaxID_' + i +
            ...
            html += '<input type="number" name="TaxVal[]" id="TaxVal_' + i +
                '" class="form-control totalLinePrice2" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="0">';
            ...
            html += '<input type="text" name="ItemTotal[]" id="ItemTotal_' + i +
                '" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">';
