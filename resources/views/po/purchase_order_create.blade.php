                        ...
                        <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-sm table-hover" id="invoiceItem">
                                        ...
                                        <thead>
                                            ...
                                            <tr class=" borde-1 border-light bg-light " style="height: 40px;">
                                                ...
                                                <th width="150" class="">QUANTITY</th>
                                            ...
                                            <tr class="p-3">
                                                ...
                                                <td valign="top">
                                                    <input type="number" name="Qty[]" id="Qty_1"
                                                        class=" form-control changesNo QtyTotal d-none" autocomplete="off"
                                                        onkeypress="return IsNumeric(event);" ondrop="return false;"
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-8 col-12  ">
                                    ...
                                    <textarea class="form-control tinymce" rows='5' name="CustomerNotes" id="note" placeholder=""> </textarea>

                                    {{-- <label for="" class="mt-2">Description</label>
                                    <textarea class="form-control tinymce " rows='5' name="DescriptionNotes" id="note"> </textarea>
 --}}
