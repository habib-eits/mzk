 ...
 @if (count($errors) > 0)
  ...
  <tbody>
   ...
   <tbody>
      ...
      <td><div align="right">{{number_format(($value->Service-$value->Taxable),0)}}</div></td>
    </tr>
   </tbody>
@endforeach
    <tr class="bg-light">
     <td width="5%" bgcolor="#CCCCCC"><div align="center"><strong></strong></div></td>
      ...
      <td width="9%" bgcolor="#CCCCCC"><div align="right"><strong>{{number_format($invoice_summary[0]->Profit,0)}} </strong></div></td>
