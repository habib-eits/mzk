                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="PONo" id="PONo" class="form-select select2 mt-5"   required="" style="width:100%;">
                                            <option value="">Select</option>
                                            <?php foreach ($po as $key => $row) : ?>
                                                <option value="{{$row->InvoiceNo}}" >{{$row->InvoiceNo}}</option> <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-1 row d-none">
                                    ...
                                    <div class="col-sm-9"> 
                                        <select name="UserI D" id="seletedVal" class="form-select select22" onchange="GetSelectedTextValue(this.value)" style="width: 100%;">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="InvoiceNo" autocomplete="off" id="InvoiceNo" class="form-control" required="" value=""></div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="p-3" >
                                          ...
                                          <td valign="top">
                                                ...
                                                <select name="ItemID0[]" id="ItemID0_{{$loop->iteration}}" class="item form-select  form-control-sm select22   changesNoo " onchange="km(this.value,1);" style="width: 100% !important;">
                                                    <option value="">select</option>
                                                    @foreach ($items as $key => $value)
                                                    <option value="{{$value->ItemID}}" {{($value->ItemID== $value1->ItemID) ? 'selected=selected':'' }} >{{$value->ItemName}}</option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden" name="ItemID[]" id="ItemID_{{$loop->iteration}}" value="{{$value1->ItemID}}">
                                          <textarea name="Description[]" id="Description[]" rows="2" class="form-control mt-1 " style="width: 100% !important;">{{$value1->Description}}</textarea></td>

                                          <td valign="top"><select name="UnitName[]" id="UnitName_{{$loop->iteration}}" class="form-select">
                                             ...
                                             <td valign="top">
                                          <input type="number" name="UnitQty[]" id="UnitQty_{{$loop->iteration}}" class=" form-control changesNo  " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->UnitQty}}">                                            </td>


                                             <td valign="top">
                                          <input type="number" name="Qty[]" id="Qty_{{$loop->iteration}}" class=" form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Qty}}">           <select  class="form-select mt-1" name="LS[]" id="LS_{{$loop->iteration}}"><option value="YES" {{($value1->LS== 'YES') ? 'selected=selected':'' }} > L/S YES</option>        <option value="NO" {{($value1->LS== 'NO') ? 'selected=selected':'' }}>LS / NO</option>    </select>                                   </td>

                                            <td valign="top">
                                          <input type="number" name="Price[]" id="Price_{{$loop->iteration}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Rate}}">                                            </td>
                                          <td valign="top"  class="d-none">


                                            <div class="input-group"  class="d-none">
                                                <input type="text" name="Discount[]" id="Discount_{{$loop->iteration}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="0"  >
                                               <span >
                                               <!-- <div class="col-sm-3">
                                        <label class="col-form-label" for="password">Salesperson </label>
                                    </div> -->
                                                <div class="col-sm-9 input-group" >
                                                    <select name="DiscountType[]" id="DiscountType_{{$loop->iteration}}" class="form-select  changesNo bg-light"  >
                                                         
                                                        <option  value="1">%</option>
                                                        <option  value="2">{{session::get('Currency')}}</option>
                                                    
                                                    </select>
                                                    <input type="hidden" name="DiscountAmountItem[]"  id="DiscountAmount_{{$loop->iteration}}" value="0">
                                                </div>
                                               </span>
                                           ...
                                           <td valign="top">
                                          <input type="number" name="Gross[]" id="Gross_{{$loop->iteration}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Gross}}">                                            </td>
                                            <td valign="top">
                                                <select name="Tax[]" id="TaxID_{{$loop->iteration}}"   required="" class="form-select  changesNo tax exclusive_cal bg-light">
                                                    <?php foreach ($tax as $key => $valueX1) : ?>
                                                        <option value="{{$valueX1->TaxPer}}" {{($valueX1->TaxPer== $value1->TaxPer) ? 'selected=selected':'' }}>{{$valueX1->Description}}</option>
                                                    <?php endforeach ?>
                                          </select>                                            </td>
                                            <td valign="top">
                                          <input type="number" name="TaxVal[]" id="TaxVal_{{$loop->iteration}}" class=" form-control totalLinePrice2" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Tax}}">                                            </td>

                                            <td valign="top">
                                          <input type="number" name="ItemTotal[]" id="ItemTotal_{{$loop->iteration}}" class=" form-control totalLinePrice " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Total}}">                                            </td>
                                        </tr>
    ...
    $(document).ready(function() {
        ...
        if (BranchID != "") {
            $.ajax({
                ...
                type: "POST",
                data: {
                    "_token": $("#csrf").val(), // Fetch CSRF token dynamically
                    BranchID: BranchID,
                    InvoiceTyp: 'Invoice',
                },
                cache: false,
...
<script>
    $(document).ready(function () {
     $('.select22').select2(); // Initialize Select2 for all elements with class 'select2'
});
</script>
@endsection