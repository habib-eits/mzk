                                ...
                                <table class="table table-bordered table-sm table-hover" id="invoiceItem">
                                    ...
                                    <tbody>
                                        <tr class="p-3" >
                                          ...
                                          <textarea name="Description[]" id="Description[]" rows="2" class="form-control mt-1 tiny-editor" style="width: 100% !important;"></textarea></td>
...
$(".addmore").on('click', function() {
    ...
    html += '<td>';
    html += '<select name="ItemID0[]" id="ItemID0_' + i + '" style="width: 100% !important;" class="form-select select2 changesNoo" onchange="km(this.value,' + i + ');">';
    ...
    html += '<textarea name="Description[]" id="Description_' + i + '" rows="2" class="form-control mt-1 kashif tiny-editor" style="width: 100% !important;"></textarea>';
    html += '</td>';
