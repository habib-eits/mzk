                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-8 col-12  ">
                                    ...
                                    <textarea class="form-control editme " rows='5' name="DescriptionNotes" id="note"> {{ $invoice_master[0]->DescriptionNotes }}</textarea>
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td><select name="ItemID0[]" id="ItemID0_' + i +
                ...
                i +
                '"> <textarea name="Description[]" id="Description[]" rows="2" class="form-control tiny-editor mt-1 tiny-editor" style="width: 100% !important;"></textarea></td>';
