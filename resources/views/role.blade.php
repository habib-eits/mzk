   ...
   <div class="mb-3">
    ...
    <hr>
                                        ...
                                        @foreach ($role as $key =>$value1)
                                         ...
                                         <h4  class="bg bg-light p-2"> {{$value1->Table}}</h4>

                                         <input name="aa" type="checkbox" class="custom-control-input {{$value1->Table}}" id=""  value="Y" checked=""  > Checkall for {{$value1->Table}}
...
foreach ($permission as $key =>$value)
    ...
    { ?>
      ...
      <div class="col-sm-2 mt-2 mb-3 ml-5">
