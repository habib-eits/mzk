                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="UserI D" id="seletedVal" class="form-select"
                                                ...
                                                @foreach ($tax as $key => $valueX1)
                                                    <option value="{{ $valueX1->TaxPer }}" {{ $invoice_master[0]->TaxPer == $valueX1->TaxPer ? 'selected' : '' }}>{{ $valueX1->Description }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                            <select name="TaxType" id="TaxType" class="form-select">
                                                <option value="TaxInclusive"
                                                    {{ 'TaxInclusive' == $invoice_master[0]->TaxType ? 'selected=selected' : '' }}>
                                                    Tax Inclusive</option>
                                                <option value="TaxExclusive"
                                                    {{ 'TaxExclusive' == $invoice_master[0]->TaxType ? 'selected=selected' : '' }}>
                                    ...
                                    <div class="mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label" for="password">Bank Details</label>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="text" id="first-name" class="form-control"
                                                name="Bank_details" value="{{ $invoice_master[0]->BankDetails }}"
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="JobNo" class="form-control"
                                                    value="{{ $invoice_master[0]->JobNo }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                                ...
                                                <select name="InvoiceType" id="InvoiceType" class="form-select">
                                                    @foreach ($invoice_type as $key => $value)
                                                        <option value="{{ $value->InvoiceType }}"
                                                            {{ $value->InvoiceType == $invoice_master[0]->InvoiceType ? 'selected=selected' : '' }}>
                                                            {{ $value->InvoiceType }}</option>
                                                    @endforeach
                                                </select>
