...
<div class="row">
     ...
     <input type="date" class="form-control form-control-sm" name="Date" value="{{date('Y-m-d')}}" style="width: 130px;" id="Date">
     </div>
     </div>
     ...
     <input type="text" class="form-control form-control-sm" name="MonthName" style="width: 130px;" readonly id="MonthName">
     </div>
     </div>
   ...
   <tbody>
      @foreach($employee as $value)
         <tr>
            ...
            @for ($i = 1; $i <= 31; $i++)
               <td>
                  <input type="number" style="width: 40px;" name="Day{{$i}}[]" pattern="[0-9]*" inputmode="decimal">
               </td>
            @endfor
         </tr>
      @endforeach
                             	...
                             	<div><button type="submit" id="submit-btn" class="btn btn-success w-sm float-right">Save</button>
