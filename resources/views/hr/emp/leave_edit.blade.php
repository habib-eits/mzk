...
<input  name="FromTime"  id="timepicker2" type="text" class="form-control" data-provide="timepicker" value="{{$FromTime}}">
...
<input  name="ToTime"  id="timepicker2_to" type="text" class="form-control" data-provide="timepicker" value="{{$ToTime}}">
                                ...
                                <div class="card">
                                  ...
                                  <input type="text" id="input-date1" class="form-control input-mask" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd/mm/yyyy" name="OMStatusDate" value="{{$leave[0]->OMStatusDate}}" {{(session::get('UserType')=='OM') ? '' : 'disabled'}}>
                                  <span class="text-muted">e.g "dd/mm/yyyy"</span>
                                  </div>
                                  </div>
                                 ...
                                 <div class="card">
                                  ...
                                  <div class="mb-3">
                                  <label for="basicpill-firstname-input">Checked on</label>
                                  <input type="text" id="input-date1" class="form-control input-mask" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd/mm/yyyy" name="HRStatusDate" value="{{$leave[0]->HRStatusDate}}" {{(session::get('UserType')=='HR') ? '' : 'disabled'}} >
                                 ...
                                 <div class="card">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-4">
                                             <div class="mb-3">
                                               <label for="basicpill-firstname-input">Checked on</label>
                                                   <input name="GMStatusDate" id="input-date1" class="form-control input-mask" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd/mm/yyyy" value="{{$leave[0]->GMStatusDate}}" {{(session::get('UserType')=='GM') ? '' : 'disabled'}}" >
                                                   <span class="text-muted">e.g "dd/mm/yyyy"</span>
                                      </div>
                                    </div> 
