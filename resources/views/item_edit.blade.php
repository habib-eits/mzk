                                    ...
                                    <div class="card-body">
                                        <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="ItemType" id="ItemType" class="form-select">
                                                        @foreach ($item_type as $value)
                                                            <option value="{{ $value->ItemType }}"
                                                                {{ $value->ItemType == $item[0]->ItemType ? 'selected=selected' : '' }}>
                                            ...
                                            <div class="mb-3 row d-none">
                                                <div class="col-sm-2">
                                                    <label class="col-form-label fw-bold" for="first-name">Unit
                                                        Quantity</label>
                                                </div>
                                                <div class="col-sm-9">
                                                    <input type="number" id="first-name" class="form-control"
                                                        name="UnitQty" value="{{ $item[0]->UnitQty }}">
                                                </div>
                                            </div>
