            ...
            <div class="container-fluid">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <form action="{{ URL('/PartyLedger1') }}" method="post" name="form1" id="form1">
                            {{ csrf_field() }}
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group" id="datepicker21">
                                    <input type="text" name="StartDate" autocomplete="off" class="form-control"
                                        ...
                                        data-date-autoclose="true" value="2022-10-01">
                    ...
                    <div class="card-footer bg-light  ">
                        ...
                        <button type="submit" class="btn btn-secondary w-lg float-right" id="PartySalesLedger2PDF">Party
                            Ledger with Sale Details</button>
                        <button type="submit" class="btn btn-success w-lg float-right" id="PartySalesLedger1PDF">Detail
                            Sales Ledger</button>
                        <button type="submit" class="btn btn-success w-lg float-right" id="PartyLedgerAccount1PDF">Party
                            Ledger Account with Amount</button>
                    </div>
                </div>
                </form>
