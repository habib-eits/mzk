...
<div align="center"  >
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="noborder_table">
    <tr>
      <td colspan="7" align="center">{{session::get('CompanyName')}} 
      </td>
    </tr>
    <tr>
      <td colspan="7" align="center"><strong>Areawise Party Balances </strong></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3">From {{dateformatman2(request()->StartDate)}} to {{dateformatman2(request()->EndDate)}}</td>
      <td colspan="4" align="right">DATED: {{date('d-m-Y')}}</td>
    </tr>
  </table>
</div>

<table>
	<tr ><td colspan="7"><strong>{{$value1->City}}</strong></td></tr>
</table>
