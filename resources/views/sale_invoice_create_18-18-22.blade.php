                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr class="p-3 bg-light">
                                            <td class="p-1 bg-light border-1 border-light text-center"><input class="case" type="checkbox" /></td>
                                            <td>
...
<script>
    /**onchange="km(this.value,'ItemID0_1');"onchange="km(this.value,'ItemID0_1');"onchange="km(this.value,'ItemID0_1');"onchange="km(this.value,'ItemID0_1');"
...
calculatediscount();
    ...
    $(document).on('change', '.changesNoo456', function() {
