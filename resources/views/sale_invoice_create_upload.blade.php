...
@section('content')
    ...
    @endforeach
                                                    ...
                                                    <input name="ItemID0[]" data-type="productCode" id="ItemID0_1"
                                                        placeholder="Please type product code and select..."
                                                        class="item form-control tags autocomplete_txt " />
                                                    ...
                                                    <input type="hidden" name="ItemID[]" id="ItemID2_1"
                                                        class="autocomplete_txt">
                                                </td>
                                                ...
                                                <td>
                                                    <select name="Tax[]" id="TaxID_1"
                                                        class="form-control changesNo tax" required="">
                                                        <?php foreach ($tax as $key => $valueX1) : ?>
                                                        <option value="{{ $valueX1->taxValue }}">{{ $valueX1->taxName }}
                                                        </option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </td>
    ...
    <script type="text/javascript">
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td> <input name="ItemID0[]" id="ItemID_' + i +
                '" placeholder="Please type product code and select..." data-type="productCode" class="item form-control tags changesNoo autocomplete_txt" /><input type="hidden" name="ItemID[]" id="ItemID2_' +
                i + '"></td>';
            ...
            html += '<td><select name="Tax[]" id="TaxID_' + i +
                '" class="form-control changesNo "><option value="0">No Tax</option><option value="5">Fbr</option><option value="10">GST</option></select></td>';
