    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <form action="{{ URL('/SaleOrderSave') }}" method="post">
                                ...
                                <div class="col-md-6">
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="SaleOrderNo" autocomplete="off"
                                                    class="form-control"
                                                    value="SO-{{ $saleorder_master[0]->SaleOrderNo }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="JobNo" autocomplete="off"
                                                    class="form-control" value="JOB-{{ $job_number->JobNo }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class='row'>
                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td bordercolor="1" class="text-center"><input class="case"
                                                        type="checkbox" /></td>
                                                <td valign="top">
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="grandtotaltax"
                                                    name="grandtotaltax" placeholder="Total Tax"
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" readonly>
                                            </div>
                                        </div>
