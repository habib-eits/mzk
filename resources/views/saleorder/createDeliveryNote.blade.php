                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="JobNo" class="form-control"
                                                    value="{{ $purchaseorder_master->JobNo }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="ChallanType" id="ChallanType" class="form-select">
                                                    @foreach ($challan_type as $key => $value)
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="subTotal"
                                                    ...
                                                    value="{{ $purchaseorder_master->SubTotal }}">
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="Total" class="form-control" step="0.01"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;"
                                                    value="{{ $purchaseorder_master->GrandTotal - $purchaseorder_master->Tax  }}">
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                            <label>Tax: &nbsp;</label>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="taxpercentage"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;" value="{{ $purchaseorder_master->Tax == 0 ? 0 : 5 }}">
                                                ...
                                                <input type="text" name="TaxpercentageAmount" class="form-control"
                                                    ...
                                                    ondrop="return false;" onpaste="return false;"
                                                    value="{{ $purchaseorder_master->Tax }}">
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="Grandtotal" class="form-control"
                                                    ...
                                                    onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                    onpaste="return false;"
                                                    value="{{ $purchaseorder_master->GrandTotal }}">
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
