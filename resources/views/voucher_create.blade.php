...
@section('content')
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <textarea name="Narration_mst" id="Narration" cols="30" rows="7" class="form-control "
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div id="vhno_div"> <img
                                                                    src="{{ asset('assets/images/ajax.gif') }}"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-1 row">
                                                        <div class="col-sm-3">
                                                            <label class="col-form-label" for="password">Voucher
                                                                Type</label>
                                                        </div>
                                                        <div class="col-sm-9">
                                                            <select class="form-select changesNooo" name="InvoiceType1"
                                                                id="InvoiceType1">
                                                                <?php foreach ($voucher_type as $key => $value): ?>
                                                                <option
                                                                    value="{{ $value->VoucherTypeID }}-{{ $value->VoucherCode }}">
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-select changesNooo" name="ChartOfAccount1"
                                                                id="ChartOfAccount1">
                                                    ...
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="input-group" id="datepicker21">
                                                                <input type="text" name="VHDate" id="VHDate"
                                                                    autocomplete="off" class="form-control"
                                                                    placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd"
                                                                    data-date-container="#datepicker21"
                                    ...
                                    <div class='row'>
                                        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                            <table
                                                class="table table-bordered table-sm table-responsive-sm table-striped table-hover"
                                                id="item_table" style="width: 100%;">
                                                <thead>
                                                    <tr class="bg-light borde-1 border-light " style="height: 40px;">
                                                        <th width="2%" class="p-1"><input id="check_all"
                                                                type="checkbox" style="margin-left: 13px;" /></th>
                                                ...
                                                <tbody>
                                                    <tr class="bg-light border-1 border-light">
                                                        <td class=" bg-light border-1 border-light"><input class="case"
                                                                type="checkbox" style="margin-left: 15px;" /></td>
                                                        <td style="width: 300px !important;">
                                                            <select name="ChOfAcc[]" id="ItemID0_1"
                                                        ...
                                                        <td style="width: 300px !important;"> <select name="SupplierID[]"
                                                                id="SupplierID_1" class="  select2 form-select "
                                                        ...
                                                        <td style="width: 300px !important;"> <select name="PartyID[]"
                                                                id="PartyID_1" class="  select2 form-select "
                                                                onchange="ajax_balance(this.value);"
                                                                style="width: 100% !important;">
                                                        ...
                                                        <td style="width: 300px !important;">
                                                            <select name="EmployeeID[]" id="EmployeeID_1"
                                                        ...
                                                        <td>
                                                            <input type="text" name="Narration[]" id="RefNo_1"
                                                                class="form-control      " autocomplete="off">
                                                        </td>


                                                        <td>
                                                            <input type="text" name="Invoice[]" id="OPVAT_1"
                                                                class=" form-control  " autocomplete="off">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="RefNo[]" id="IPVAT_1"
                                                                class=" form-control  " autocomplete="off">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <input type="text" name="Debit[]" id="debit_1"
                                                                class=" form-control changesNo totalLinePricee"
                                                ...
                                                <tfooter>
                                                    <tr class="bg-light border-1 border-light " style="height: 40px;">
                                                        ...
                                                        <th width="5%"> </th>
                                                        <th width="5%"> </th>
                                                        <th width="5%"><input type="text" readonly=""
                                                                class=" form-control " id="sum_dr"> </th>
                                                    </tr>
                                                </tfooter>
                                            </table>
                                        </div>
                      ...
                      <h2>Back TO Tutorial: <a href="#"> Invoice System </a> </h2>
                                ...
                                <div class="card-footer bg-light">
                                    <div><button type="submit"
                                            class="btn btn-primary w-lg me-50 float-right">Save</button>
                                        <a href="{{ URL('/Voucher') }}"
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td><select name="ChOfAcc[]" id="ItemID0_' + i +
                '" class=" select2 form-select cls changesNoo" style="width: 100% !important;"> <option value="">Select Account</option> @foreach ($chartofaccount as $key => $value) <option value="{{ $value->ChartOfAccountID }}">{{ $value->ChartOfAccountID }}-{{ $value->ChartOfAccountName }}</option>@endforeach</select> </td>';
            ...
            html += '<td><select name="SupplierID[]" id="SupplierID_' + i +
                '"  onchange="ajax_balance(this.value);" class="form-select select2" style="width: 100% !important;"> <option value="">Select Supplier</option>@foreach ($supplier as $key => $value) <option value="{{ $value->SupplierID }}">{{ $value->SupplierName }}</option>@endforeach</select></td>';

            html += '<td><select name="PartyID[]" id="PartyID_' + i +
                '" class="form-select select2" onchange="ajax_balance(this.value);" style="width: 100% !important;"><option value="">Select PartyID</option>@foreach ($party as $key => $value)<option value="{{ $value->PartyID }}">{{ $value->PartyName }}</option>@endforeach</select></td>';


            html += '<td><select name="EmployeeID[]" id="EmployeeID_' + i +
                '" class="form-select select2" onchange="ajax_balance(this.value);" style="width: 100% !important;"><option value="">Select Employee</option>@foreach ($employee as $key => $value)<option value="{{ $value->EmployeeID }}">{{ $value->full_name }}</option>@endforeach</select></td>';
            html += '<td><input type="text" name="Narration[]" id="RefNo_' + i +
                '" class="form-control changesNo" ></td>';

            html += '<td><input type="text" name="Invoice[]" id="OPVAT_' + i +
            ...
            html += '<td><input type="text" name="RefNo[]" id="IPVAT_' + i +
                '" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
            html += '<td><input type="text" name="Debit[]" id="debit_' + i +
                '" class=" form-control changesNo totalLinePricee" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01"  ></td>';
            html += '</tr>';
            i++;
            $('table').append(html);
            $('.select2').select2();
