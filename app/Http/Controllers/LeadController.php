...
class LeadController extends Controller
{
    public function index(Request $request)
    {
        ...
        try {
            ...
            {   
                ...
                $agents = DB::table('users')->where('id',$id)->get();
    ...
    public function create()
    {
        try {
            ...
            $agents = User::where('role', '!=', 'Admin')->get();
            $campaigns = Campaign::all();
            return view('leads.create', compact('branches', 'agents', 'services', 'subServices', 'campaigns'));
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        try {
            ...
            return view('leads.edit', compact('lead', 'branches', 'agents', 'services', 'subServices', 'statuses', 'Q_statuses', 'campaigns'));
        } catch (\Exception $e) {
            // DB::rollBack();
            // dd($e->getMessage());
            return back()->with('error', $e->getMessage())->withInput();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
               ...
               if( $request->qualified_status=='Closed Won')
            {
